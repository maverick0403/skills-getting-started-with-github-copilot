      ...
      Object.entries(activities).forEach(([name, details]) => {
        ...
        const participantItems = participants.length
          ? participants
              .map(
                (person) =>
                  `<li class="participant-item"><span>${person}</span><button type="button" class="participant-delete" data-activity="${name}" data-email="${person}" aria-label="Remove ${person}">✕</button></li>`
              )
              .join("")
